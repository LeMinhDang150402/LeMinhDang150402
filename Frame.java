...
public class Frame extends JFrame implements ActionListener {
	...
	private JMenuBar creatMenu() {
		...
		JMenuItem add4 = menuFile.add(createMenuItem("New", KeyEvent.VK_N, CTRL_MASK));
		JMenuItem add5 = menuFile.add(createMenuItem("Open", KeyEvent.VK_O, CTRL_MASK));
		JMenuItem add6 = menuFile.add(createMenuItem("Save", KeyEvent.VK_S, CTRL_MASK));
		menuFile.addSeparator();
		JMenuItem add = menuFile.add(createMenuItem("Exit", KeyEvent.VK_X, CTRL_MASK));

		JMenu menuHelp = new JMenu("Help");
		menuHelp.setMnemonic(KeyEvent.VK_H);
		JMenuItem add2 = menuHelp.add(createMenuItem("Help", KeyEvent.VK_H, CTRL_MASK));
		JMenuItem add3 = menuHelp.add(createMenuItem("About", KeyEvent.VK_A, CTRL_MASK));
	...
	private void showDialogDelete() {
		...
		if (index <= 0) {
			...
			if (index > 0) {
				// show message dialog
				Line ml = myDraw.getData().getArrMyLine().get(index);
